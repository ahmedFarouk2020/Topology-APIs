...
int main() {
    ...
    cout<< "Expected output: "<< "list of all devices connected to this netlistnode\n";
    ...
    cout<< "Expected output: "<< "null\n" ;
    cout<< "Actual output: " <<apis.queryDevicesWithNetlistNode("top2","drain") << "\n\n";
    cout<< "testcase3: non-existing topology with non-existing netlistnode\n";
    cout<< "Expected output: "<< "null\n" ;
    cout<< "Actual output: " <<apis.queryDevicesWithNetlistNode("top2","a2") << "\n\n";
    ...
    apis.deleteTopology("top1"); // delete the stored topology
